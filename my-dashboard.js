const T = globalThis, j = T.ShadowRoot && (T.ShadyCSS === void 0 || T.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, z = /* @__PURE__ */ Symbol(), B = /* @__PURE__ */ new WeakMap();
let X = class {
  constructor(t, e, s) {
...
const rt = (r) => new X(typeof r == "string" ? r : r + "", void 0, z), nt = (r, ...t) => {
...
const { is: ht, defineProperty: at, getOwnPropertyDescriptor: lt, getOwnPropertyNames: ct, getOwnPropertySymbols: dt, getPrototypeOf: pt } = Object, f = globalThis, W = f.trustedTypes, ut = W ? W.emptyScript : "", $t = f.reactiveElementPolyfillSupport, b = (r, t) => r, D = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? ut : null;
      break;
  ...
  return e;
} }, Y = (r, t) => !ht(r, t), q = { attribute: !0, type: String, converter: D, reflect: !1, useDefault: !1, hasChanged: Y };
...
let g = class extends HTMLElement {
  ...
  requestUpdate(t, e, s) {
    if (t !== void 0) {
      ...
      if (s ?? (s = i.getPropertyOptions(t)), !((s.hasChanged ?? Y)(n, e) || s.useDefault && s.reflect && n === this._$Ej?.get(t) && !this.hasAttribute(i._$Eu(t, s)))) return;
      this.C(t, e, s);
    }
...
g.elementStyles = [], g.shadowRootOptions = { mode: "open" }, g[b("elementProperties")] = /* @__PURE__ */ new Map(), g[b("finalized")] = /* @__PURE__ */ new Map(), $t?.({ ReactiveElement: g }), (f.reactiveElementVersions ?? (f.reactiveElementVersions = [])).push("2.1.1");
const w = globalThis, N = w.trustedTypes, J = N ? N.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, tt = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, et = "?" + _, _t = `<${et}>`, y = document, x = () => y.createComment(""), U = (r) => r === null || typeof r != "object" && typeof r != "function", I = Array.isArray, ft = (r) => I(r) || typeof r?.[Symbol.iterator] == "function", k = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, K = /-->/g, Z = />/g, A = RegExp(`>|${k}(?:([^\\s"'>=/]+)(${k}*=${k}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), F = /'/g, G = /"/g, st = /^(?:script|style|textarea|title)$/i, At = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), mt = At(1), v = /* @__PURE__ */ Symbol.for("lit-noChange"), d = /* @__PURE__ */ Symbol.for("lit-nothing"), Q = /* @__PURE__ */ new WeakMap(), m = y.createTreeWalker(y, 129);
function it(r, t) {
...
const yt = (r, t) => {
  ...
  for (let l = 0; l < e; l++) {
    const h = r[l];
    let c, p, a = -1, u = 0;
    for (; u < h.length && (o.lastIndex = u, p = o.exec(h), p !== null); ) u = o.lastIndex, o === S ? p[1] === "!--" ? o = K : p[1] !== void 0 ? o = Z : p[2] !== void 0 ? (st.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = A) : p[3] !== void 0 && (o = A) : o === A ? p[0] === ">" ? (o = i ?? S, a = -1) : p[1] === void 0 ? a = -2 : (a = o.lastIndex - p[2].length, c = p[1], o = p[3] === void 0 ? A : p[3] === '"' ? G : F) : o === G || o === F ? o = A : o === K || o === Z ? o = S : (o = A, i = void 0);
    const $ = o === A && r[l + 1].startsWith("/>") ? " " : "";
    n += o === S ? h + _t : a >= 0 ? (s.push(c), h.slice(0, a) + tt + h.slice(a) + _ + $) : h + _ + (a === -2 ? l : $);
  }
    ...
    for (; (i = m.nextNode()) !== null && h.length < l; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const a of i.getAttributeNames()) if (a.endsWith(tt)) {
          const u = p[o++], $ = i.getAttribute(a).split(_), M = /([.?@])?(.*)/.exec(u);
          h.push({ type: 1, index: n, name: M[2], strings: $, ctor: M[1] === "." ? vt : M[1] === "?" ? Et : M[1] === "@" ? St : R }), i.removeAttribute(a);
...
class H {
  ...
  $(t) {
    const { values: e, _$litType$: s } = t, i = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = O.createElement(it(s.h, s.h[0]), this.options)), s);
...
class R {
  ...
  _$AI(t, e = this, s, i) {
    ...
    if (n === void 0) t = E(this, t, e, 0), o = !U(t) || t !== this._$AH && t !== v, o && (this._$AH = t);
      ...
      const l = t;
      let h, c;
      for (t = n[0], h = 0; h < n.length - 1; h++) c = E(this, l[s + h], e, h), c === v && (c = this._$AH[h]), o || (o = !U(c) || c !== this._$AH[h]), c === d ? t = d : t !== d && (t += (c ?? "") + n[h + 1]), this._$AH[h] = c;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
const wt = w.litHtmlPolyfillSupport;
wt?.(O, H), (w.litHtmlVersions ?? (w.litHtmlVersions = [])).push("3.3.1");
const Ct = (r, t, e) => {
...
const Pt = C.litElementPolyfillSupport;
Pt?.({ LitElement: P });
